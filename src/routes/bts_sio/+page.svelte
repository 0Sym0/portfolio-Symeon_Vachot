...
<section class="glass section topSections d-flex align-items-center justify-content-center flex-column my-4 p-4" id="realisations">
    ...
    <p class="grilleResponsive text-center mt-3">Grille de compétences du BTS non disponible sur format mobile et tablette </p>
    <a class="glass section bottomSections text-center p-1 mt-3" href="{base}/preuves/tableauSyntheseOfficiel.pdf" target="_blank" style="max-width: 300px;">Grille de compétences officielle</a>
</section>
